...
namespace App.Pages.Shared.Components
{
    public class ProductViewComponent : ViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync(int id, ViewMode viewMode)
        {
            ...
            switch (productType)
            {
                case ProductType.Case:
                    ...
                    ProductVm = new ProductVm(computerCase, mainImageUrl, viewMode);
                break;
                ...
                case ProductType.DiskDrive:
                    ...
                    ProductVm = new ProductVm(diskDrive, mainImageUrl, viewMode);
                    break;
                ...
                case ProductType.GraphicCard:
                    ...
                    ProductVm = new ProductVm(graphicCard, mainImageUrl, viewMode);
                    break;
                ...
                case ProductType.Motherboard:
                    ...
                    ProductVm = new ProductVm(motherBoard, mainImageUrl, viewMode);
                    break;
                ...
                case ProductType.PowerSupply:
                    ...
                    ProductVm = new ProductVm(powerSupply, mainImageUrl, viewMode);
                    break;
                ...
                case ProductType.DesktopComputer:
                    ...
                    ProductVm = new ProductVm(desktopComputer, mainImageUrl, viewMode);
                    break;
                ...
                case ProductType.Keyboard:
                    ...
                    ProductVm = new ProductVm(keyboard, mainImageUrl, viewMode);
                    break;
                ...
                case ProductType.Laptop:
                    ...
                    ProductVm = new ProductVm(laptop, mainImageUrl, viewMode);
                    break;
                ...
                case ProductType.Monitor:
                    ...
                    ProductVm = new ProductVm(monitor, mainImageUrl, viewMode);
                    break;
                ...
                case ProductType.Mouse:
                    ...
                    ProductVm = new ProductVm(mouse, mainImageUrl, viewMode);
                    break;
                ...
                case ProductType.Printer:
                    ...
                    ProductVm = new ProductVm(printer, mainImageUrl, viewMode);
                    break;
                ...
                case ProductType.Smartphone:
                    ...
                    ProductVm = new ProductVm(smartphone, mainImageUrl, viewMode);
                    break;

                case ProductType.Televisor:
                    mainImageUrl = linkGenerator.GetPathByPage("/products/case", "MainImage", new { productId = id });
                    Televisor televisor = context.Televisors.Find(id);
                    ProductVm = new ProductVm(televisor, mainImageUrl, viewMode);
                    break;
