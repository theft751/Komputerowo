        ...
        public async Task<IViewComponentResult> InvokeAsync(int id, ViewMode viewMode)
        {
            ...
            switch (productType)
            {
                case ProductType.Case:
                    ...
                    ProductVm = new ProductVm(computerCase, mainImageUrl);
                break;
                ...
                case ProductType.DiskDrive:
                    ...
                    ProductVm = new ProductVm(diskDrive, mainImageUrl);
                    break;
                ...
                case ProductType.GraphicCard:
                    ...
                    ProductVm = new ProductVm(graphicCard, mainImageUrl);
                    break;
                ...
                case ProductType.Motherboard:
                    ...
                    ProductVm = new ProductVm(motherBoard, mainImageUrl);
                    break;
                ...
                case ProductType.PowerSupply:
                    ...
                    ProductVm = new ProductVm(powerSupply, mainImageUrl);
                    break;
                ...
                case ProductType.DesktopComputer:
                    ...
                    ProductVm = new ProductVm(desktopComputer, mainImageUrl);
                    break;
                ...
                case ProductType.Keyboard:
                    ...
                    ProductVm = new ProductVm(keyboard, mainImageUrl);
                    break;
                ...
                case ProductType.Laptop:
                    ...
                    ProductVm = new ProductVm(laptop, mainImageUrl);
                    break;
                ...
                case ProductType.Monitor:
                    ...
                    ProductVm = new ProductVm(monitor, mainImageUrl);
                    break;
                ...
                case ProductType.Mouse:
                    ...
                    ProductVm = new ProductVm(mouse, mainImageUrl);
                    break;
                ...
                case ProductType.Printer:
                    ...
                    ProductVm = new ProductVm(printer, mainImageUrl);
                    break;
                ...
                case ProductType.Smartphone:
                    ...
                    ProductVm = new ProductVm(smartphone, mainImageUrl);
                    break;

                case ProductType.Televisor:
                    mainImageUrl = linkGenerator.GetPathByPage("/products/case", "MainImage", new { productId = id });
                    Televisor televisor = context.Televisors.Find(id);
                    ProductVm = new ProductVm(televisor, mainImageUrl);
                    break;
